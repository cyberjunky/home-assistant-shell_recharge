...
If you discover a security vulnerability in this integration, please report it privately by creating a [security advisory](https://github.com/cyberjunky/home-assistant-shell_recharge/security/advisories) on GitHub.
...
This integration communicates with Shell Recharge endpoints over the internet (HTTPS):

- Keep your Home Assistant instance on a secure network
- Update all your network equipment regularly

### Credential Storage

If you create a private charger instance your Shell Recharge data (email, password, API key) is stored in Home Assistant's configuration:
